...
test.describe('Leave Module Functionality Tests', () => {
    ...
    test('2.Verify Comment field accepts input', async () => {
    ...
    test('3.Verify My Leave page opens', async () => {
    ...
    test('7.Verify Reset button clickable', async () => {
    ...
    test('8.Verify Leave List page opens', async () => {
    ...
    test('13.Verify Assign Leave comment field editable', async () => {
    ...
    test('14.Verify page refresh keeps session', async () => {
        await page.reload();
        await expect(leavePage.leaveHeading).toBeVisible();
    });
});